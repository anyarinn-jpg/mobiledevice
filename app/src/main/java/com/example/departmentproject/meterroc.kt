...
data class RoomRecord(
    ...
    @SerializedName("current_elec") val currentElec: Double?,  // ต้องสะกดแบบนี้
    ...
    @SerializedName("bill_month") val billMonth: String?, // รับค่า null ได้
    @SerializedName("bill_year") val billYear: String?,   // รับค่า null ได้
